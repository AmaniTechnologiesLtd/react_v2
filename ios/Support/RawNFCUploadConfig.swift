...
//  Android wrapper (android/.../modules/NFC.kt uploadV1). This holder just caches the values
//  initAmani() already receives from JS so the raw upload can reach them without needing
