...
const nativeComponentStyles = exports.nativeComponentStyles = _reactNative.StyleSheet.create({
  container: {
    flex: 1,
    width: '100%',
    height: '100%'
...
const isPlatformVersionHigher = (majorVersion, minorVersion = 0) => {
...
const checkMethodIsCorrectPlatformVersion = (fnName, platform, majorVersion, minorVersion = 0) => {
