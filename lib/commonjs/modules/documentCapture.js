...
exports.DocumentCaptureHelper = void 0;
class DocumentCaptureHelper {
   ...
   */
  setType(type) {
    return this.platformModule.documentCaptureSetType({
      type
    });
  }
   ...
   */
  async start() {
    let imageData = await this.platformModule.documentCaptureStart({
      documentCount: 1
    });
    return `data:image/jpeg;base64,${imageData}`;
  }
}
exports.DocumentCaptureHelper = DocumentCaptureHelper;
