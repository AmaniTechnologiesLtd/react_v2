...
var _documentCapture = require("./modules/documentCapture");
...
class AmaniSDK {
   ...
   */
  get documentCapture() {
    return new _documentCapture.DocumentCaptureHelper(this.platformModule);
  }
  ...
  setDelegate(delegateEvents) {
    ...
    let onMRZCapturedListener = this.eventEmitter.addListener('onMRZCaptured', body => {
      let parsedBody = body;
