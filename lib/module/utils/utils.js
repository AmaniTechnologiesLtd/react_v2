...
export const isPlatformVersionHigher = (majorVersion, minorVersion = 0) => {
...
export const checkMethodIsCorrectPlatformVersion = (fnName, platform, majorVersion, minorVersion = 0) => {
